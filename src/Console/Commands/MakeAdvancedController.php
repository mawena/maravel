...
/**
 * Commande pour créer des contrôleurs API avancés
 * 
 * Cette commande génère des contrôleurs qui étendent APIController
 * avec un système de gestion avancé des API REST.
 */
class MakeAdvancedController extends GeneratorCommand
{
	/**
	 * Le nom et la signature de la commande
	 */
	protected $name = 'make:advanced-controller';

	/**
	 * La description de la commande
	 */
	protected $description = 'Créer un contrôleur API avancé avec APIController et système de gestion REST';
